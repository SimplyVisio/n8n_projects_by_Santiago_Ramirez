...
---
🔗 Distributed Microservice Repositories

This repository contains the core orchestration layer (n8n workflows + infrastructure config).
...
---
**SANTIAGO RAMÍREZ
Data Systems & Automation Manager | AI Infrastructure Architect
Colima, Mexico | (+52) 312 225 4289 | santiago@outreach.socialmask.com.mx
LinkedIn: https://www.linkedin.com/in/santiago-emiliano-ram%C3%ADrez-v%C3%A1zquez-583957397
GitHub portfolio: github.com/SimplyVisio/n8n_projects_by_Santiago_Ramirez*
⚠ Architectural Note:

This repository contains the orchestration layer.
Each production microservice is maintained in its own repository for isolation, scalability, and CI/CD independence.
